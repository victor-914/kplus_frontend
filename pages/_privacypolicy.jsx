  ...
  return (
    <div style={{ width: "90%", margin: "auto", textAlign: "justify" }}>
      ...
      <p>
        ...
        personal information is to you, and are committed to protecting your
        personal data. This Notice covers the personal information we collect or
      ...
      <ul>
        <li>
          ...
          house address. We collect this information to provide inquiry and
          support.
        </li>
        <li>
          Verification data: This includes information gotten from the
          verification of ownership of the property to be disposed and includes
          personal information gotten from land registry, certificate of
          occupancy, photographs and video of the property.
        </li>
        <li>
        ...
        <li>
          ...
          of contract, its duration and the services to be provided, signatures
          and names, feedback.
        </li>
      </ul>
      ...
      <ul>
        <li>
          ...
          our platform. This information includes your name, email address,
          photo, ID card, country, phone number, location and time zone.
        </li>
        <li>
          Marketing/Communication: We use this data to provide information about
          our services or new product to you. We also use this information to
          communicate with you in order to provide inquiry and support. The
          information includes phone number, call log, email address and email
          content.
        </li>
        <li>
        ...
        <li>
          ...
          visit, the time spent on each page, the location and other details
          about your visit.
        </li>
        <li>
          Financial data: This includes the financial information about you such
          as your account number, account name, PIN, and CVV.
        </li>
        <li>
          Contract or Business Data: includes personal data collected in the
          course of providing services or contractual relationships such as
          information about the contracts such as date of conclusion, the type
          of contract, its duration and the services to be provided, complaints,
      ...
      <p>
        ...
        measure in place to block a person below the age of 18years from
        registering into our platforms. In the event that need arises for us to
      ...
      <p>
        ...
        you use our website. The cookies are sent back to our computer each time
        you visit our website. Cookies make it easier for us to give you a
        better experience online. You can stop your browser from accepting
      ...
      <ul>
        <li>
          ...
          up into our website or our services, communicate with us or create
          wallet account with us.
        </li>
        <li>
        ...
        <li>
          ...
          data about you from various third parties and public sources available
          to us such as your financial institution, open government sources,
      ...
      <ul>
        ...
        <li>
          To resolve dispute resolution that may arise in the course of carrying
      ...
      <p>
        ...
        on an appropriate lawful basis if we intend to use it for another
      ...
      <p>
        ...
        data. Kindly contact us if you need further details or clarity about the
      ...
      <ul>
        <li>
          ...
          have entered with us or we have entered with your company or take
          pre-contractual steps at your instruction.
        </li>
        <li>
      ...
      <p>
        ...
        an unauthorized way, altered or disclosed. Also, we limit access to your
      ...
      <p>
        ...
        adjudication of the claim. In some circumstances, we will anonymize your
        ...
        information indefinitely without further notice to you. We will securely
      ...
      <p>
        ...
        access your personal data or to exercise any of your other rights. This
        is a security measure to ensure that personal data is not disclosed to
        any person who has no right to receive it. We may also contact you to
      ...
      <p>
        ...
        competent court of law to enforce your data protection rights. We would,
